...
Review bundles surface the fresh-clone local HEAD, clone HEAD, source-control local HEAD, and source-control remote default SHA at the bundle-manifest top level, and `handoff:bundle:verify` compares those summaries with the copied fresh-clone smoke artifact.
